...
int main()
{
	...
	for (;;) {
		...
		cout << "22. Добавить дробь в конец списка" << endl;
		cout << "23. Добавить дробь в начало списка" << endl;
		cout << "24. Добавить смешанную дробь в конец списка" << endl;
		cout << "25. Добавить смешанную дробь в начало списка" << endl;
		cout << "26. Добавить дробь с результатом в конец списка" << endl;
		cout << "27. Добавить дробь с результатом в начало списка" << endl;
		cout << "28. Удалить дробь из начала списка" << endl;
